...
_SIDECAR_TASK_PATHS = {
    ...
    "depression_support": "application/tasks/chat_synthetic-depression-support",
...
def _application_for(application_id: str) -> Any:
    ...
    if application_id == "depression_support":
        return HTTPChatbotApplication(
            application_id="depression_support",
            default_context="mental_health_support",
            base_url=_sidecar_base_url(
                "CHATBOT_UPSTREAM_DEPRESSION",
                "DEPRESSION_CHATBOT_URL",
                "http://127.0.0.1:8906",
            ),
        )
        ...
        *,
        ...
        try:
            ...
            upstream_hint = {
                ...
                "depression_support": "CHATBOT_UPSTREAM_DEPRESSION",
